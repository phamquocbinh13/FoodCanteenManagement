...
mixin _$AuthSession {
 ...
 AuthenticatedUser get user; String get accessToken; String get refreshToken; DateTime get expiresAt;
...
@useResult
$Res call({
 AuthenticatedUser user, String accessToken, String refreshToken, DateTime expiresAt
});
...
as AuthenticatedUser,accessToken: null == accessToken ? _self.accessToken : accessToken // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AuthenticatedUser user,  String accessToken,  String refreshToken,  DateTime expiresAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AuthenticatedUser user,  String accessToken,  String refreshToken,  DateTime expiresAt)  $default,) {final _that = this;
switch (_that) {
case _AuthSession():
return $default(_that.user,_that.accessToken,_that.refreshToken,_that.expiresAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AuthenticatedUser user,  String accessToken,  String refreshToken,  DateTime expiresAt)?  $default,) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.user,_that.accessToken,_that.refreshToken,_that.expiresAt);case _:
  return null;
...
class _AuthSession implements AuthSession {
  const _AuthSession({required this.user, required this.accessToken, required this.refreshToken, required this.expiresAt});
