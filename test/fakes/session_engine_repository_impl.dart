...
import 'package:food_canteen_management/domain/entities/session_engine_snapshot.dart';
import 'package:food_canteen_management/domain/entities/session_payment_summary.dart';
...
import 'package:food_canteen_management/domain/repositories/session_engine_repository.dart';
import 'package:food_canteen_management/domain/services/session_state_machine.dart';
import 'package:food_canteen_management/domain/services/table_domain_service.dart';
...
final class SessionEngineRepositoryImpl implements SessionEngineRepository {
  ...
  SessionEngineSnapshot _snapshot(
    ...
    return SessionEngineSnapshot(
      ...
      requestIds: _dataSource.requestIdsForSession(session.id),
    );
  }
}
