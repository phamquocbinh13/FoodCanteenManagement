...
function riceGroups(itemId, prefix) {
    return {
        groups: [
            {
                id: `grp-${prefix}-size`,
...
async function deleteCustomizationsForItems(prisma, itemIds) {
    if (itemIds.length === 0)
        return;
...
async function tryDeleteOrDeactivateItem(prisma, itemId) {
...
async function main() {
    ...
    try {
        ...
        console.log(`Demo menu seeded for ${RID}: ${CATEGORIES.length} categories, ` +
...
//# sourceMappingURL=seed-demo-menu.js.map